...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt]
  ...
  \item \textbf{Settlement}: payment two bank working days after the auction
    date (\textit{T}\,+\,2), with possible exceptions around public holidays;
    redemption at face value (CHF 1\,000\,000 per bill) on the maturity date.%
    \footnote{SNB, \textit{Settlement of SNB repo transactions and SNB Bills to
    remain unchanged at T+2 even after migration to T+1 settlement cycle},
    circular letter, 30 March 2026 (Department III, Money Market and Foreign
    Exchange).  The circular confirms that even after Switzerland's planned
    migration to the T+1 settlement cycle for exchange-traded securities
    (effective 11 October 2027, aligned with the EU/EEA and UK), SNB Bills and
    SNB repo transactions will remain at T+2.}
...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt]
  ...
  \item \textbf{Settlement}: payment two bank working days after the auction
    date (T+2), with possible exceptions around public holidays; redemption
    T+2+term.\footnote{Ibid.\ The same SNB circular of 30 March 2026 confirms
    that term repo settlement remains at T+2 following Swiss interbank market
    standards set by SIX Repo Ltd (announcement of 10 November 2025).}
...
\begin{tabular}{L{3.8cm} L{2.5cm} L{7.5cm}}
  ...
  \texttt{payment\_date}         & date    & Settlement date (T+2 bank working
                                             days after auction; exceptions
